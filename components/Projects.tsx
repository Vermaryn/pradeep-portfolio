                    ...
                    <div className="flex flex-wrap items-start justify-between gap-5 mb-8">
                      ...
                      <div className="flex gap-2 shrink-0">
                        <a 
                          ...
                          className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-all" style={{ color: T.fg3, border: `1px solid ${T.borderLg}`, background: T.card }}>
                          <Github size={14} /> Code
                        </a>
                        <a 
                          href={project.demo}
                          target="_blank" 
                          rel="noopener noreferrer"
                          className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-all" style={{ color: "#c7d2fe", border: `1px solid ${project.accent}40`, background: `${project.accent}12` }}>
